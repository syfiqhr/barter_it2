...
class _ProfileTabScreenState extends State<ProfileTabScreen> {
                          ...
                          child: GestureDetector(
                            ...
                            child: Padding(
                              ...
                              child: CachedNetworkImage(
                                imageUrl:
                                    "${MyConfig().SERVER}/barter_it2/assets/profileimages/${widget.user.id}.png?v=$val",
            ...
            TextButton(
              ...
              onPressed: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (content) => const Register(),
                  ),
                );
              },
            ),
  ...
  void _updateProfileImage(image) {
    ...
    http.post(
      Uri.parse("${MyConfig().SERVER}/barter_it2/php/update_profile3.php"),
      body: {
